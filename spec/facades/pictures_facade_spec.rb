...
RSpec.describe PicturesFacade do
  ...
  describe "#_pictures_for_country" do
    it "returns 10 pictures for the country" do
      ...
      expect(pictures[0].url).to eq("https://images.unsplash.com/photo-1518105779142-d975f22f1b0a?crop=entropy&cs=tinysrgb&fm=jpg&ixid=Mnw0MTkyOTN8MHwxfHNlYXJjaHwxfHxNZXhpY298ZW58MHx8fHwxNjc4MTUzODg5&ixlib=rb-4.0.3&q=80")
    end
  end
end